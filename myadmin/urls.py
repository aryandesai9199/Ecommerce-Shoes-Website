...
urlpatterns = [
    ...
    path("add-featured-products/", views.add_featured_products, name="add featured-products/"),
    path("update-featured-products/", views.update_featured_products, name="update-featured-products")
]